...
<section class="books_list">
    ...
    <div class="container home_container books_container">
        ...
        <article class="book_card exchange_books">
            ...
            <p class="written--secondary">Vendu par : Juju1432</p>
        </article>
        ...
        <article class="book_card exchange_books">
            ...
            <p class="written--secondary">Vendu par : Christiane75014</p>
        </article>
        ...
        <article class="book_card exchange_books">
            ...
            <p class="written--secondary">Vendu par : Hamzalecture</p>
        </article>
        ...
        <article class="book_card exchange_books">
            ...
            <p class="written--secondary">Vendu par : Lou&Ben50</p>
        </article>
        ...
        <article class="book_card exchange_books">
            ...
            <p class="written--secondary">Vendu par : Lolobzh</p>
        </article>
        ...
        <article class="book_card exchange_books">
            ...
            <p class="written--secondary">Vendu par : Sas634</p>
        </article>
        ...
        <article class="book_card exchange_books">
            ...
            <p class="written--secondary">Vendu par : ML95</p>
        </article>
        ...
        <article class="book_card exchange_books">
            ...
            <p class="written--secondary">Vendu par : Verogo33</p>
        </article>
        ...
        <article class="book_card exchange_books">
            ...
            <p class="written--secondary">Vendu par : AnikkaBrahms</p>
        </article>
        ...
        <article class="book_card exchange_books">
            ...
            <p class="written--secondary">Vendu par : Victoirefabr912</p>
        </article>
